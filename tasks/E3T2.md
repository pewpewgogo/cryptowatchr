# E3T2 — Percent alert creation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the flow for creating percent alerts. Users select a coin(s) or 'any in my list', enter a percentage, and a timeframe. Write tests to tests/specs/E3T2.json and append the command to tests/commands.json.
