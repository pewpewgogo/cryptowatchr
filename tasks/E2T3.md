# E2T3 — Remove coin from watchlist

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the inline Remove buttons to remove a coin from the user's watchlist. Write tests to tests/specs/E2T3.json and append the command to tests/commands.json.
