# E4T3 — Alert Message Formatting

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the alert message format:
- "ALERT: BTC moved — old: $59,800.00 → new: $60,500.00 (+1.17%)" format
- Include alert type and link/button to view or pause that alert

Create tests/specs/E4T3.json and append to tests/commands.json
