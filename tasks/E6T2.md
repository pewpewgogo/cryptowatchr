# E6T2 — Price Sample Management

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement price sample management:
- Store PriceSample time-series for each ticker for at least 24 hours
- Sample cadence of 1 minute
- Cache last-known price per ticker in Redis for fast reads

This task does not require a tests/specs file as it's not a user-facing command.
