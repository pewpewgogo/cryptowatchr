# E6T1 — /admin_stats command for owner

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the /admin_stats command that is available to the configured owner Telegram ID. Display total users, active users (last 30d), and top-fired alert rules. Write tests to tests/specs/E6T1.json and append the command to tests/commands.json.
