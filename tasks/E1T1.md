# E1T1 — /start command and onboarding flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the /start command that explains the bot's features and initiates the onboarding flow. Write tests to tests/specs/E1T1.json and append the command to tests/commands.json.
