# E5T1 — Poller job for price snapshots

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement a poller job that runs every 60 seconds to fetch current prices for all tracked coins and store them as price snapshots. Write tests to tests/specs/E5T1.json and append the command to tests/commands.json.
