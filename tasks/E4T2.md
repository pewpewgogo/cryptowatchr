# E4T2 — Morning summary setup and delivery

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the optional morning summary feature. Users can set a time for a daily summary of their watched coins. Write tests to tests/specs/E4T2.json and append the command to tests/commands.json.
