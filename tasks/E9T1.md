# E9T1 — CoinGecko integration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement integration with CoinGecko as the primary price provider. Write tests to tests/specs/E9T1.json and append the command to tests/commands.json.
