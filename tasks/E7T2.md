# E7T2 — Friendly error messages for users

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement friendly error messages for users when /price data is unavailable. Write tests to tests/specs/E7T2.json and append the command to tests/commands.json.
